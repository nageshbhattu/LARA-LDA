...
public class Utilities {
    ...
    public static HashMap<Integer, String> sortHashMapByValues(HashMap<Integer, String> rankpred) {
        List<Map.Entry<Integer,String>> list = new LinkedList<>(rankpred.entrySet());

...
public class Vector4Review {
    ...
    public Vector4Review(String ID, double[] ratings, boolean isTrain) {
        m_ID = ID;
        m_4train = isTrain;
    ...
    public void setAspect(int i, int[] featIndices, double[] featValues) {
        m_aspectV[i] = new SpaVector(featIndices,featValues);
    }
    ...
    public void getAspectRating(double[] beta, int v) {
        for (int i = 0; i < m_aspectV.length; i++) {
            ...
            //    System.out.println(m_pred[i]+":::"+m_aspectV.length);
        }
    }
